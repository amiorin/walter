...
uv run walter -- package describe # providers, compute reachability, workstation summary
...
uv run walter -- package git-check lock build unlock-any # advanced Git/lock workflow helpers
```
